...
public class ReverseDrawerLayout extends ViewGroup {
    private static final String TAG = "ReverseDrawerLayout";
    ...
    private static final int DRAWER_OVERHANG = 30; // dp
    ...
    private int mDrawerOverhang;
    private float mDrawerOverhangDecimalOffset;
    ...
    public ReverseDrawerLayout(Context context) {
        this(context, null);
    }

    public ReverseDrawerLayout(Context context, AttributeSet attrs) {
     ...
     * any drawer within this layout. ReverseDrawerLayout will still respond to calls to
     ...
     *
     * <p>This allows the application to restrict the user's ability to open or close
     * the given drawer. ReverseDrawerLayout will still respond to calls to {@link #openDrawer(int)},
    ...
    void updateDrawerState(int forGravity, int activeState, View activeDrawer) {
        ...
        if (activeDrawer != null && activeState == STATE_IDLE) {
            ...
            if (lp.onScreen == mDrawerOverhangDecimalOffset) {
        ...
        if (widthMode != MeasureSpec.EXACTLY || heightMode != MeasureSpec.EXACTLY) {
            if (isInEditMode()) {
                ...
                throw new IllegalArgumentException(
                        "ReverseDrawerLayout must be measured with MeasureSpec.EXACTLY.");
            }
        }
    ...
    public void closeDrawer(View drawerView) {
        ...
        if (mFirstLayout) {
            ...
            if (checkDrawerViewAbsoluteGravity(drawerView, Gravity.LEFT)) {
                mLeftDragger.smoothSlideViewTo(drawerView, -drawerView.getWidth() + mDrawerOverhang,
                        drawerView.getTop());
            } else {
                mRightDragger.smoothSlideViewTo(drawerView, getWidth() - mDrawerOverhang,
                        drawerView.getTop());
            }
        }
        invalidate();
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void removeCallbacks() {
            ReverseDrawerLayout.this.removeCallbacks(mPeekRunnable);
        }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (checkDrawerViewAbsoluteGravity(releasedChild, Gravity.LEFT)) {
                left = xvel > 0 || xvel == 0 && offset > 0.5f ? 0 :
                        -childWidth + mDrawerOverhang;
            } else {
                final int width = getWidth();
                left = xvel < 0 || xvel == 0 && offset > 0.5f ? width - childWidth :
                        width - mDrawerOverhang;
            }
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(ReverseDrawerLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(ReverseDrawerLayout.class.getName());
        }
        ...
        public boolean dispatchPopulateAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            // ReverseDrawerLayout invalidate the entire contents of the screen (like
